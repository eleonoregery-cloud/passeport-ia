...
const STEPS = [
  ...
  { title: 'Maîtrise de l’IA - article 4', intro: 'Évaluez la formation des personnes qui utilisent ou supervisent l’IA.', screens: [[
    ...
    ['risks', 'Quels risques cette sensibilisation abordait-elle ?', ['Erreurs et hallucinations', 'Vérification humaine', 'Données personnelles et confidentialité', 'Secrets d’affaires et cybersécurité', 'Biais et discrimination', 'Propriété intellectuelle', 'Transparence des contenus', 'Usages interdits', 'Aucun de ces sujets', 'Je ne sais pas'], true],
    ['adaptedTraining', 'Le contenu était-il adapté à vos métiers, outils et responsabilités ?', ['Oui, parcours adaptés', 'Partiellement', 'Non, uniquement général', 'Aucune formation', 'Je ne sais pas']],
